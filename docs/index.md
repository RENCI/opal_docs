...
Documentation for frontend, as well as standing up OPAL frontend, can be found in the following Github repository (https://github.com/RENCI/opal-frontend).
[![OPAL Backend Repo](images/opalfrontendrepo.png)](https://github.com/RENCI/opal-frontend)
...
[![PFAS Observations Data Model](images/OPAL-DataModel-V4.3-07_16_25.png)](miscfiles/OPAL-DataModel-V4.3-07_16_25.pdf)
